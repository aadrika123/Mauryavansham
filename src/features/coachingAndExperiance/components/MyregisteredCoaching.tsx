      ...
      {selectedCoaching && (
        <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
          <div className="bg-white rounded-xl shadow-lg w-[90%] max-w-2xl p-6 relative max-h-[90vh] overflow-y-auto">
            ...
            <h2 className="text-2xl font-bold mb-3 text-center">{selectedCoaching.centerName}</h2>
            ...
            <div className="space-y-2 text-gray-700">
              ...
              <p>
                <strong>Address:</strong> {selectedCoaching.address}, {selectedCoaching.city}, {selectedCoaching.state}{' '}
              ...
              <p>
                <strong>Registered On:</strong> {new Date(selectedCoaching.createdAt || '').toLocaleDateString()}
              </p>
              <p>
