          ...
          <div className="relative p-4 h-full">
            ...
            <div className="text-center relative z-10 h-full flex flex-col justify-center">
              ...
              <div className="border-2 border-dashed border-amber-400 rounded-lg p-4 bg-gradient-to-br from-amber-50 to-yellow-100 h-full flex flex-col justify-center">
                <h3 className="text-lg font-bold text-amber-800 mb-3">Book Your Ad</h3>

                <div className="space-y-3 flex-1 flex flex-col justify-center">
                  <p className="text-xs text-amber-700 leading-relaxed">Premium vertical space for your business</p>
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-amber-600">Contact us for this premium vertical space</p>
                  </div>
                </div>
              </div>
            </div>
