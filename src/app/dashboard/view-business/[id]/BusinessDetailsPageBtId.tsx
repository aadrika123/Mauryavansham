      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            <div className="flex-1">
              <h1 className="text-4xl font-bold text-gray-900 mb-4">{business.organizationName}</h1>
              <div className="flex flex-wrap gap-4 mb-4">
                <span
                  className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-medium ${
                    business.premiumCategory === 'Platinum'
                      ? 'bg-purple-100 text-purple-800'
                      : business.premiumCategory === 'Gold'
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h2 className="text-2xl font-semibold text-gray-900 mb-6 border-b pb-2">📋 Organization Information</h2>
          ...
          {/* Legal Information */}
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h2 className="text-2xl font-semibold text-gray-900 mb-6 border-b pb-2">📄 Legal Information</h2>
            <div className="space-y-4">
              <div className="flex flex-col">
                <label className="text-sm font-medium text-gray-500">CIN Number</label>
                <p className="text-lg text-gray-900 font-mono">{business.cin || 'Not provided'}</p>
              </div>
              <div className="flex flex-col">
                <label className="text-sm font-medium text-gray-500">GST Number</label>
                <p className="text-lg text-gray-900 font-mono">{business.gst || 'Not provided'}</p>
              </div>
              <div className="flex flex-col">
                <label className="text-sm font-medium text-gray-500">Udyam Registration</label>
                <p className="text-lg text-gray-900 font-mono">{business.udyam || 'Not provided'}</p>
              </div>
            </div>
          </div>
          ...
          {business.categories && business.categories.length > 0 && (
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h2 className="text-2xl font-semibold text-gray-900 mb-6 border-b pb-2">🏷️ Business Categories</h2>
              <div className="space-y-3">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mt-8">
          <h2 className="text-2xl font-semibold text-gray-900 mb-6 border-b pb-2">📍 Address Information</h2>
        ...
        {/* Photos Section */}
        <div className="bg-white rounded-xl shadow-lg p-6 mt-8">
          <h2 className="text-2xl font-semibold text-gray-900 mb-6 border-b pb-2">📸 Business Photos</h2>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div>
              ...
              <p className="text-blue-100">
                {business.organizationType} • {business.businessCategory} •{business.partners?.length || 0} Partner(s) •
                Established{' '}
                {business.dateOfestablishment ? new Date(business.dateOfestablishment).getFullYear() : 'N/A'}
              </p>
            </div>
          </div>
        </div>
