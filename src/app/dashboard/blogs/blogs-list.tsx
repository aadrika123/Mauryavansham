        ...
        <Card className="text-center py-12">
          <CardContent>
            <div className="flex flex-col items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900">No blogs yet</h3>
                <p className="text-gray-600 mt-1">Get started by creating your first blog post</p>
              </div>
              <Link href="/dashboard/blogs/create">
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    <Link href={`/dashboard/blogs/${blog.id}`} className="flex-1">
                    ...
                    {(blog.status === 'draft' || blog.status === 'rejected') && (
                      <Link href={`/dashboard/blogs/${blog.id}/edit`} className="flex-1">
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent>
          ...
          <div className="space-y-2">
            ...
            <Input value={deleteReason} onChange={e => setDeleteReason(e.target.value)} placeholder="Enter reason..." />
          </div>
