...
export default async function EventsPage() {
  ...
  const mockEvents: Event[] = [
    ...
    {
      id: 1,
      title: "Raksha Bandhan Celebration 2025",
      description:
        "Celebrate the sacred bond of siblings with traditional rituals, music, food, and fun activities.",
      image: "/placeholder.svg?height=300&width=500&text=Raksha+Bandhan",
      date: "2025-08-09", // Raksha Bandhan in 2025 falls on August 9
      time: "17:00",
      location: "Community Hall, Ranchi",
      attendees: 180,
      maxAttendees: 250,
      organizer: "Mauryavansh Cultural Forum",
      type: "In-Person" as const,
      category: "Cultural",
      isFeatured: true,
    },

    {
      ...
      description:
        "Learn about preserving our cultural heritage and traditional practices for future generations.",
    ...
    },
    {
      ...
      description:
        "Empowering young leaders in our community with skills and networking opportunities.",
    ...
    },
    {
      ...
      description:
        "Learn authentic Maurya cuisine recipes from experienced community chefs.",
