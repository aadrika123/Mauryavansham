...
import { ArrowLeft, Crown, BookOpen, Scroll } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-8 text-center">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <Card className="overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
            <div className="h-64 bg-gradient-to-br from-amber-900 to-red-900 relative">
          ...
          {/* Samrat Ashoka Card */}
          <Card className="overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
            <div className="h-64 bg-gradient-to-br from-pink-300 to-purple-400 relative">
              <Crown className="h-16 w-16 text-yellow-400 absolute top-6 left-6" />
            </div>
            <CardContent className="p-6 bg-yellow-50">
              <div className="flex items-center justify-between mb-3">
