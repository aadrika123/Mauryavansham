    ...
    <div className="min-h-screen px-4 sm:px-6 lg:px-12 bg-gradient-to-b from-yellow-50 to-orange-50">
      ...
      <div className="container mx-auto text-center">
        ...
        <div className="mb-6">
          ...
          <p className="text-base sm:text-lg text-red-600 max-w-3xl mx-auto leading-relaxed px-2">
            From the divine lineage of Lord Ram to the mighty Mauryan Empire, discover the rich history and proud
            heritage of the Maurya community that spans over 2500 years.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 md:px-10 lg:px-36">
          {heritageList.length === 0 ? (
            <p className="text-gray-600 text-center col-span-full">No heritage records found.</p>
          ) : (
              ...
              <Card key={item.id} className="overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                ...
                <CardContent className="p-4 sm:p-6 bg-yellow-50">
                  <div className="flex items-center justify-between mb-2 sm:mb-3">
                    <h3 className="text-lg sm:text-xl font-bold text-red-700">{item.title}</h3>
                    {item.badge && (
                  ...
                  <p className="text-gray-700 text-sm sm:text-base text-left">{item.description}</p>
                </CardContent>
              </Card>
            ))
          )}
      ...
      <div className="bg-yellow-50 py-12 sm:py-16 px-4 sm:px-8">
        <div className="container mx-auto text-center mb-8 sm:mb-12">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-red-700">Sacred Knowledge</h1>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
          <div className="text-center bg-yellow-100 p-6 sm:p-8 rounded-lg shadow hover:shadow-yellow-200">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-red-700 mb-2">Ramayana</h3>
            <p className="text-gray-600 text-sm sm:text-base">The epic tale of our divine ancestor Lord Ram</p>
          </div>
          <div className="text-center bg-yellow-100 p-6 sm:p-8 rounded-lg shadow hover:shadow-yellow-200">
            <Scroll className="h-12 w-12 sm:h-16 sm:w-16 text-yellow-500 mx-auto mb-4" />
            <h3 className="text-lg sm:text-xl font-bold text-red-700 mb-2">Arthashastra</h3>
            <p className="text-gray-600 text-sm sm:text-base">Chanakya's wisdom that guided the Mauryan Empire</p>
          </div>
          <div className="text-center bg-yellow-100 p-6 sm:p-8 rounded-lg shadow hover:shadow-yellow-200">
            <Crown className="h-12 w-12 sm:h-16 sm:w-16 text-red-600 mx-auto mb-4" />
            <h3 className="text-lg sm:text-xl font-bold text-red-700 mb-2">Edicts of Ashoka</h3>
            <p className="text-gray-600 text-sm sm:text-base">The dharmic principles that shaped civilization</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-yellow-50 py-12 sm:py-16 px-4 sm:px-8">
        <div className="container mx-auto text-center mb-8 sm:mb-12">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-red-700 mb-2">Our Divine Lineage</h1>
          <p className="text-base sm:text-lg text-red-600">The sacred genealogy connecting us to the divine</p>
        </div>
      ...
      <div className="bg-yellow-50 py-8 px-4 sm:px-12">
        <div className="bg-[linear-gradient(125deg,#ffae00,#8B0000,#FF5C00)] text-white py-10 sm:py-16 rounded-2xl container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-8 text-center">
            <div>
              <h3 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2">धर्म (Dharma)</h3>
              <p className="text-orange-100 text-sm sm:text-base">Righteousness and moral duty</p>
            </div>
            <div>
              <h3 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2">अर्थ (Artha)</h3>
              <p className="text-orange-100 text-sm sm:text-base">Prosperity and material security</p>
            </div>
            <div>
              <h3 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2">काम (Kama)</h3>
              <p className="text-orange-100 text-sm sm:text-base">Love and emotional fulfillment</p>
            </div>
            <div>
              <h3 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2">मोक्ष (Moksha)</h3>
              <p className="text-orange-100 text-sm sm:text-base">Liberation and spiritual growth</p>
            </div>
          </div>
        </div>
      </div>
