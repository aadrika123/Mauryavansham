      ...
      <div className="max-w-7xl mx-auto p-6 ">
                ...
                <div className="flex flex-col lg:flex-row">
                  ...
                  <div className="lg:w-2/3 p-6">
                    <div className="flex items-center gap-2 mb-4">
                      <Badge
                        className={getPriorityColor(featuredCampaign.priority)}
                      >
                        {featuredCampaign.priority}
                      </Badge>
                    ...
                    <div className="mb-6">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="text-gray-600">
                          of {formatCurrency(featuredCampaign.goal)}
                        </span>
                      </div>
                      <Progress
                        value={getPercentageFunded(
        ...
        {activeTab === "completed" && (
          <Card className="p-8 text-center">
            ...
            <p className="text-gray-600">
              Successfully completed fundraising campaigns will appear here
            </p>
          </Card>
        )}
        ...
        {activeTab === "my-donations" && (
          <Card className="p-8 text-center">
            ...
            <p className="text-gray-600">
              Your donation history and contributions will be displayed here
            </p>
          </Card>
        )}
        ...
        {activeTab === "impact" && (
          <Card className="p-8 text-center">
            ...
            <p className="text-gray-600">
              Community impact statistics and success stories will be shown here
            </p>
          </Card>
        )}
      </div>
