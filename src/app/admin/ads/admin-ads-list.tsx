...
import { CheckCircle, XCircle, Calendar, User, Eye, Clock } from "lucide-react";
    ...
    <Card key={ad.id} className="hover:shadow-lg transition-shadow">
      <CardHeader className="pb-3">
        ...
        <div className="flex items-start justify-between">
          ...
          <Badge
            className={getStatusColor(ad.status, ad.isActive, ad.isExpired)}
          >
    ...
    <Tabs defaultValue="pending" className="space-y-6">
      <TabsList>
        <TabsTrigger value="pending">
          Pending ({filterAds("pending").length})
        </TabsTrigger>
        <TabsTrigger value="active">
          Active ({filterAds("active").length})
        </TabsTrigger>
        <TabsTrigger value="approved">
          Approved ({filterAds("approved").length})
        </TabsTrigger>
        <TabsTrigger value="rejected">
          Rejected ({filterAds("rejected").length})
        </TabsTrigger>
