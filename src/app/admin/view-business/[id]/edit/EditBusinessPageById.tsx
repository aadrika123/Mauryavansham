    ...
    const fetchBusinessData = async () => {
      try {
        ...
        setFormData({
          ...
          partners: businessData.data.partners?.length > 0 ? businessData.data.partners : [{ name: '' }],
          categories: businessData.data.categories?.length > 0 ? businessData.data.categories : [{ main: '', sub: '' }],
          registeredAddress: {
            ...
            branchOffices: businessData.data.registeredAddress?.branchOffices || []
          },
      ...
      <div className="max-w-4xl mx-auto p-6 min-h-screen">
        ...
        <Card className="shadow-lg border border-yellow-200">
          <CardContent className="p-8">
            <h1 className="text-2xl font-bold text-red-700 mb-6 text-center">Edit Business Details</h1>
