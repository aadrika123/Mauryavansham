      ...
      .then((data: BookedDate[]) => {
        ...
        if (formData.placementId !== null) {
          setPlacementBookedDates(prev => ({
            ...prev,
            [formData.placementId as number]: dates
          }));
        }
      })
      .catch(() =>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="banner">
                Banner Image (350x500px) for vertical ads or (900x300px) for horizontal ads
              </Label>
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6">
                {imagePreview ? (
                  ...
                  <div className="text-center">
                    ...
                    <label htmlFor="banner-upload" className="cursor-pointer mt-4 block">
                      <span className="block text-sm font-medium text-gray-900">Upload banner image</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <DatePicker
                  ...
                  required
                  dayClassName={date => (isBooked(date) ? 'bg-red-200 text-red-700' : 'bg-green-200 text-green-900')}
                />
              </div>
              <div className="space-y-2">
                ...
                <DatePicker
                  ...
                  excludeDates={bookedDates}
                  minDate={formData.fromDate ? addDays(parseDate(formData.fromDate)!, 1) : addDays(new Date(), 1)}
                  dateFormat="dd-MM-yyyy"
                  className="w-full border rounded px-3 py-2"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-[350px]">
            ...
            <div className="flex justify-end mt-4">
              <Button variant="outline" size="sm" onClick={() => setShowCalendarPopup(false)}>
                Close
              </Button>
            </div>
          </div>
