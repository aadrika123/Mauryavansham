        ...
        <div className="space-y-4">
          ...
          {blog.approvedAt && (
            <div className="flex items-center gap-2 text-sm text-green-700 bg-green-50 p-2 rounded">
              ...
              <span>
                Approved on {format(new Date(blog.approvedAt), "MMM d, yyyy")}
              </span>
            </div>
          )}
              ...
              <div className="p-3 bg-orange-50 border border-orange-200 rounded-lg space-y-1">
                ...
                {blog.removedBy && (
                  <p className="text-sm text-orange-700">
                    Removed By:{" "}
                    <span className="font-medium">{blog.removedByName}</span>
                  </p>
                )}
              </div>
            )}
            ...
            <div className="space-y-3 p-4 bg-red-50 border border-red-200 rounded-lg">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  disabled={
                    actionLoading === blog.id || !rejectionReason.trim()
                  }
                >
  ...
  return (
    <>
      <Tabs defaultValue="pending" className="space-y-6">
        ...
        {["pending", "approved", "rejected", "removed", "all"].map(
          (tabValue) => (
                  ...
                  <CardContent>
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <p className="text-gray-500 font-medium">
                        No {tabValue === "all" ? "" : tabValue} blogs found
                      </p>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to approve this blog? It will be published
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              onClick={() =>
                showApproveDialog && handleApprove(showApproveDialog)
              }
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-3">
            <p className="text-sm text-gray-600">
              Please provide a reason for removing this blog. This action will
              hide the blog from all users.
            </p>
            <div className="space-y-2">
