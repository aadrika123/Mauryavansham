  ...
  return (
    <div className="bg-orange-50 p-20">
      <div className="max-w-md mx-auto p-6 bg-yellow-50 rounded-md shadow-md border border-yellow-200">
        <h2 className="text-2xl font-semibold text-center mb-6 text-red-700">Forgot Password</h2>

        {error && <div className="mb-4 p-3 text-red-800 bg-red-100 rounded border border-red-300">{error}</div>}
        {message && (
          <div className="mb-4 p-3 text-green-800 bg-green-100 rounded border border-green-300">{message}</div>
        )}

        {step === 'email' && (
          <>
            <label htmlFor="email" className="block mb-2 font-medium text-red-700">
        ...
        {step === 'otp' && (
          <>
            ...
            <label htmlFor="otp" className="block mb-2 font-medium text-red-700">
              Enter OTP
            </label>
            <input
              id="otp"
        ...
        {step === 'reset' && (
          <>
            <label htmlFor="newPassword" className="block mb-2 font-medium text-red-700">
              Enter new password
            </label>
